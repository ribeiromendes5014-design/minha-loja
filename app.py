...
# =====================================
# VENDAS (Layout completo com promoções)
# =====================================
if view == "Vendas":
    show_logo("main")
...
if view == "Promoções":
    ...
    with st.expander("Cadastrar promoção", expanded=True):
        ...
        if produtos.empty:
            ...
            with col2:
                data_ini = st.date_input("Início", value=date.today())
            with col3:
                data_fim = st.date_input("Término", value=date.today() + timedelta(days=7))
