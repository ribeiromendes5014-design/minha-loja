...
if view == "Produtos":
    ...
    if foto_codigo is not None:
        ...
        if codigo_lido:
            st.session_state["codigo_barras_temp"] = codigo_lido
...
if st.button("Adicionar produto"):
    novo = {
        ...
        "CodigoBarras": str(st.session_state.get("codigo_barras_temp", "")).strip()
    }
        ...
        if "edit_prod" in st.session_state:
            ...
            if not row.empty:
                ...
                with c3:
                    ...
                    novo_cb = st.text_input("Código de Barras", value=str(row.get("CodigoBarras","")))
                    foto_codigo_edit = st.camera_input("📷 Atualizar código de barras")
